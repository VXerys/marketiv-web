      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="px-4 py-2.5 rounded-xl border border-dashed border-primary/40 hover:border-primary text-xs font-bold text-primary hover:bg-primary-50/10 transition-colors cursor-pointer select-none"
          >
            Reset Filter
          </button>
        )}
