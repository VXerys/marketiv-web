# 05 — Creator Dashboard

## 1. Purpose
Mendefinisikan dashboard Kreator untuk saldo, pekerjaan aktif, submission, Job Pool, Rate Card, dan order berjalan.
...
## 4. User Stories
1. Sebagai Kreator, saya ingin melihat pekerjaan aktif dan saldo agar tahu prioritas kerja.
2. Sebagai Kreator, saya ingin akses cepat ke Job Pool.
3. Sebagai Kreator, saya ingin melihat status submission dan payout.

## 5. Main Flow
1. Kreator login.
2. Dashboard memuat saldo dan pekerjaan.
3. Dashboard menampilkan campaign direkomendasikan.
4. Dashboard menampilkan order Rate Card aktif.
5. Kreator lanjut ke aksi prioritas.
...
## 8. Validation Rules
- User harus role KREATOR.
- Saldo hanya read-only dari backend.
- Campaign rekomendasi hanya status Aktif.
- Order hanya milik kreator terkait.

## 9. Backend Responsibilities
- Menyediakan query pekerjaan aktif.
- Menyediakan wallet summary read-only.
- Menyediakan list job pool ringkas.
- Tidak mengizinkan kreator membuat campaign.

## 10. Frontend Responsibilities
- Menampilkan saldo tersedia/tertahan.
- Menampilkan CTA Lihat Job Pool dan Kelola Rate Card.
- Menampilkan status submission.
- Menampilkan warning jika profile belum verified.
...
## 12. Edge Cases
- Kreator belum verified.
- Saldo nol.
- Tidak ada job aktif.
- Submission ditolak dan butuh revisi link.
...
- [ ] Kreator dapat melihat summary personal.
- [ ] CTA sesuai state profile.
- [ ] Saldo tidak bisa diubah dari frontend.
- [ ] Job Pool tidak menampilkan campaign penuh sebagai claimable.
